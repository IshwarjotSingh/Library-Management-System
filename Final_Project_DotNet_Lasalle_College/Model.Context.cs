...
namespace Final_Project_DotNet_Lasalle_College
{
    ...
    public partial class Final_Library_management_LasalleCollegeEntities : DbContext
    {
        public Final_Library_management_LasalleCollegeEntities()
            : base("name=Final_Library_management_LasalleCollegeEntities")
        {
        }
